...
This repository collects metadata from a list of currently available Java JRE/JDK distributions and stores it as JSON files in the [`metadata/`](./db/metadata) directory.
